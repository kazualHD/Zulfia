...
const Children = () => {
    ...
    <div class="video2"> <iframe class='video' width="560" height="315" src="https://www.youtube.com/embed/cKn1E_tBD3M?si=UwMhwZU9iv0QrM52" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
     ...
     <div className="main-content child-container-grid "> 
      <div>
      <span className='pl-5'>Также</span> провожу игры, на концентрацию и распределение внимания, на тренировку помяти, логики, скорости мышления: "Запрещенная цифра", "Числа", "Запрещенный цвет", "Что изменилось", "Найди лишнее", "Раз, два, три!", "Кулачок", "Комарики", и т.д. Благодоря этим заданиям занаятия проходят увлекательно и разнообразно
      <div>
        <br/>
