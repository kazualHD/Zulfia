...
const Children = () => {
    ...
    <div class="greeting child-container-grid ">
        <h3 class="h1-greeting ">Ментальная арфметика, как средство развития интиеллектуальных способностей дошкольников</h3>
        <img src={happyChildren} alt="" class="img-greeting p-20"/>
    </div>

    <section class="main-content child-container-grid">
    <div>Социальный заказ государства и общества ставит перед современной педагогикой задачу по созданию условий обеспечивающих выявление и развитию детской одаренности через внедрение инновационных образовательных технологий. Результатом такого поиска стал курс ментальная арифметика.</div>
    <div> <b>Ментальная арифметика</b> – это программа развития умственных  способностей и творческого  потенциала детей с помощью арифметических вычислений на абакусе. Решение нестандартных  задач, выполнение творческих заданий социально педагогической направленности.</div>
    <div><b> Задачи ментальной арифметики</b> 
         <ul>
    ...
    <div><b>Общий принцип менаталной арифметики</b> 
         <ol>
            <li> Ребенок учится считать на счетах, трогает их, перемещает бусинки, запоминает их расположение, развивает мелкую моторику; </li>
            <li> Далее ребенок представляет счеты в уме;</li>
            <li>Затем начинает производить арифметические операции, мысленно перемещая бусинки в уме.</li>
         </ol>
    </div>

    <div> Занятия проводятся по 25 - 30 минут 2 раза в неделю. В занятия включены игры и упражнения на развитие внимания, памяти, логики, воображения, мелкой моторики.</div>
    <div><b>Структурные элементы занятия:</b> 
         <ol>
            <li> Кинезиологические упражнения. Рисование двумя руками. </li>
            <li> Разминка. Динамические игры.</li>
            <li>Работа с абакусом</li>
            <li>Флеш-карты</li>
            <li>Игры и занятия на развитие мелкой моторики, внимания, памяти, речи, логики.</li>
            <li>Работа в рабочих тетрадях.</li>
            <li>Большие и малые числа.</li>
            <li>Таблица Шульте – Абакус</li>
            <li>Струп – тест.</li>
            <li>Ментальный счет.</li>
         </ol>
    </div>
   
    </section>
    <div class='child-container-grid main-content a-center '> Вначале я знакомлю ребят с понятием, что такое ментальная арифметика, с главным инструментом для счета - Абакус на доступном детям языке. </div>
    <div class='mental-arif ' >
        <img src={pc2} alt="" class='png-2' />
     </div>
    ...
    <div className="main-content child-container-grid">
     ...
     <div className="main-content child-container-grid">
        <div> На каждом занятии мы работаем с флеш-картами. Слово «flash» переводится как «вспышка» или «молния». Значит, при помощи флеш-карты мы мгновенно должны передать информацию из одного полушария мозга в другое.</div>
          <div className="d-flex g-50 p-20">
              <img src={pc10} className='f-2' alt="" />
              <img src={pc11} className='f-1' alt="" />
          </div>
     </div>
     <div className="d-flex child-container-grid p-20">
        <div  className="d-flex d-column p-20 f-1">
            <div>Флеш-карты — это карточки с графическим изображением чисел на абакусе. Это непременная составляющая в приобретении навыков ментального счета. Без этого ребенку будет непросто освоить ментальную арифметику.
                 При работе с флеш-картами, педагог быстро показывает карточку, примерно 1-2 секунды, а воспитанник должен быстро понять какое число и назвать его.
                 Благодаря работе с флеш-картами, ребенок тренирует внимание, наблюдательность, а скорость обработки информации увеличивается. 
            </div>
            <div>В результате упражнений с флеш-картами:
            <ul>
                <li>Тренируется визуальный образ числа </li>
                <li>У ребенка развивается фотографическая память</li>
            </ul>
            </div>
     ...
     <div className="main-content child-container-grid ">
        <div>Обязательно каждое занятие работаем с Абакусом. Решаем примеры на сложение и вычитание целых чисел. Перед началом работы всгда обговариваем правила работы с абакусом: нижние бусинки перемещает вверх БОЛЬШОЙ палец, вниз УКАЗАТЕЛЬНЫЙ палец. Верхнюю бусинку перемещает вверх и вниз УКАЗАТЕЛЬНЫЙ палец. Помогает нам вспомнить правило, пальчиковая гимнастика:
        <div className="m-20">
            <p>Чтобы правильно считать, </p>
            <p>Надо пальчики размять: </p>
            <p>Вверх – большой, </p>
            <p>Вниз – указательный, </p>
            <p>Вышел – крабик замечательный!</p>
        </div>
        </div>
     </div>
     ...
     <div class='child-container-grid p-20'>  
      ...
      <div className="main-content child-container-grid greeting">Ментальный счет. После того, как поработали  на физическом абакусе, детей прошу отодвинуть абакусы и подвожу  к визуализации. <br/>Предлагаю представить абакус в уме и перемещать бусины без использования абакуса, т.е приступаем к решению примеров ментально. 
    </div>
    ...
    <div className="d-flex child-container-grid p-20 m-50 g-50 ">
        ...
        <div className="main-content child-container-grid greeting"> Еще одно упражнение Струп – тест, он отлично тренирует память детей, ребенку нужно внимательно читать слова и называть не слово, которое написано, а назвать цвет,  которым это слово написано. </div>
        
     <div className="child-container-grid">
        <div className="d-flex p-20 g-20">
            <img src={pc25} alt="" className="p-20" />
            <img src={pc26} alt="" className="p-20" />
        </div>
     </div>

     <div className="main-content child-container-grid greeting"> 
      Интересно проходит простое, но довольно эффективное упражнение для концентрации внимания «Большие и малые числа». Необходимо на картинке найти определенную цифру. 
     </div>
     ...
     <div className="d-flex child-container-grid p-20   ">
        ...
        <div className='a-center'>Онлайн-занятия.<br/> С детьми которые не посещают долго детский сад, по каким либо причинам, провожу занятия дистанционно.</div>
        <div className="d-flex p-20 g-20">
